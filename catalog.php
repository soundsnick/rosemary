...
<body>
  ...
  <section class="section-cat">
    <h1 class="title" style="text-align: center; padding-top: 50px;">Мишки с лентой</h1>
    <div class="container">
      <div class="grid" style="grid-gap: 20px;">
        <div class="item">
          ...
          <span class="item__cost">11000 тг</span>
    ...
    <h1 class="title" style="text-align: center; padding-top: 50px;">Мишки с сердцем</h1>
    <div class="container">
      <div class="grid" style="grid-gap: 20px;">
        <div class="item">
          <div class="item__img">
